...
using PurchaseOrderEntity = IBS.Models.Filpride.AccountsPayable.PurchaseOrder;
...
namespace IBS.Models.Filpride.Integrated
{
    public class DeliveryReceipt : BaseEntity
    {
        ...
        public ICollection<DeliveryReceiptDetail> Details { get; set; } = new List<DeliveryReceiptDetail>();
    }
}
